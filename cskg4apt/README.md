<div align="center">
  <img src="https://raw.githubusercontent.com/peng-gao-lab/CSKG4APT/main/cskg4apt/static/logo.png" alt="Logo" width="200">
...
<p align="center">
  ...
  <a href='https://cskg4apt.github.io/' target='_blank'><img src='https://img.shields.io/badge/Project-Website-turquoise'></a>
  <a href="https://pepy.tech/projects/cskg4apt" target='_blank'><img src="https://img.shields.io/pepy/dt/cskg4apt?color=green&label=Downloads" alt="Downloads"></a>
</p>
...
📢 [2026/02] CSKG4APT was presented as a [tutorial](https://cskg4apt.github.io/prism-workshop) at the PRISM Workshop (Co-located with NDSS).

📦 [2025/10] CSKG4APT Python package released! Install with `pip install cskg4apt` for seamless integration into your Python projects.

🌟 [2025/07] CSKG4APT now features an intuitive Gradio interface! Submit threat intelligence text and instantly visualize extracted interactive graphs.

🔥 [2025/04] We released the camera-ready paper on [arxiv](https://arxiv.org/pdf/2410.21060).

🔥 [2025/02] CSKG4APT is accepted at 2025 IEEE European Symposium on Security and Privacy ([Euro S&P](https://eurosp2025.ieee-security.org/index.html)).
...
**CSKG4APT** is a framework that leverages optimized in-context learning (ICL) of large language models (LLMs) to automatically extract cyber threat intelligence (CTI) from unstructured text and construct cybersecurity knowledge graphs (CSKG).

<p align="center">
  <img src="https://raw.githubusercontent.com/peng-gao-lab/CSKG4APT/main/cskg4apt/static/overview.png" alt="CSKG4APT Framework Overview" width="600"/>
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/peng-gao-lab/CSKG4APT/main/cskg4apt/static/webui.png" alt="CSKG4APT WebUI" width="600"/>
</p>
...
CSKG4APT supports multiple AI providers for flexibility:
...
```bash
git clone https://github.com/peng-gao-lab/CSKG4APT.git
cd CSKG4APT
...
```bash
# Process a file
cskg4apt --input-file report.txt

# Process text directly
cskg4apt --text "APT29 exploited CVE-2023-1234 using PowerShell..."

# Specify provider and model
cskg4apt -i report.txt --provider openai --model gpt-4o

# Save to custom location
cskg4apt -i report.txt --output results/analysis.json
```
...
If you use CSKG4APT in your research, please cite our paper:

```bibtex
@inproceedings{cheng2025cskg4aptautomaticcyberthreat,
      title={CSKG4APT: Automatic Cyber Threat Intelligence Knowledge Graph Construction Using Large Language Models},
...
We warmly welcome industry collaboration. If you’re interested in building on CSKG4APT or exploring joint initiatives, please email yutongcheng@vt.edu or saimon.tsegai@vt.edu, we’d be happy to set up a brief call to discuss ideas.
