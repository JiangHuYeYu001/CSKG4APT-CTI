...
def _get_cskg4apt_extractor():
	from .cskg4apt_extractor import CSKG4APTExtractor as _cls
	return _cls


def _get_apt_attributor():
	from .attribution.apt_analyzer import APTAttributor as _cls
	return _cls


def _get_diamond_model_analyzer():
	from .attribution.diamond_model import DiamondModelAnalyzer as _cls
	return _cls
