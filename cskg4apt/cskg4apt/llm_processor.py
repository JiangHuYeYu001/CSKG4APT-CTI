...
from cskg4apt.utils.path_utils import resolve_path
...
class UrlSourceInput:
	...
	def summarize(self, prompt: list[dict]) -> tuple[str, float, dict]:
		"""Summarize URL content into CSKG4APT-ready text using configured model."""
	...
	def repair_summary(self, source_result: dict, initial_summary: str, focused_text: str) -> tuple[str, float, dict]:
		"""Repair non-compliant summary output into strict CSKG4APT-ready paragraph format."""
		repair_prompt = (
	...
	def is_well_formed_cti_paragraph(self, summary_text: str) -> bool:
		"""Check strict formatting/quality expectations for CSKG4APT-ready summary text."""
