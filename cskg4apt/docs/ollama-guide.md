# Using CSKG4APT with Ollama

CSKG4APT supports local LLM inference through Ollama, providing a free and private alternative to cloud-based AI providers.
...
cskg4apt -i report.txt --provider Ollama --model llama3.1:70b --embedding-model nomic-embed-text
```

### Web Interface

1. Start the web interface: `cskg4apt`
