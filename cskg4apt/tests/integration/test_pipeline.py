"""Integration tests for CSKG4APT pipeline."""
...
class TestProcessCTIReport:
	...
	def test_process_cti_report_with_mocked_llm(
		...
		# Mock LLM responses
		mock_completion = mocker.patch("cskg4apt.llm_processor.litellm.completion")
		mock_embedding = mocker.patch("cskg4apt.graph_constructor.litellm.embedding")
...
class TestPipelineComponents:
	...
	def test_ie_to_et_flow(self, mocker):
		...
		from cskg4apt.llm_processor import LLMExtractor, LLMTagger
