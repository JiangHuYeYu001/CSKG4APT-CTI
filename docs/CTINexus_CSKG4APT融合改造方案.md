...
**新建文件**: `cskg4apt/schemas/cskg4apt_ontology.py`
...
**修改文件**: `cskg4apt/prompts/ie_prompts.py`
...
**修改文件**: `cskg4apt/graph_constructor.py`
...
**文件**: `cskg4apt/prompts/et_prompts.py`
...
**新建文件**: `cskg4apt/graph_db/neo4j_manager.py`
...
**新建文件**: `cskg4apt/attribution/diamond_model.py`
...
**新建文件**: `cskg4apt/scraper/playwright_scraper.py`
...
**修改文件**: `cskg4apt/utils/gradio_utils.py`
...
**`cskg4apt/config/config.yaml`** 新增：
...
3. **CSKG4APT的工程化** → 四阶段流水线+Gradio UI
